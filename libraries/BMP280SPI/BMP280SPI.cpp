...
BMP280SPI::BMP280SPI(
	...
	: mCSPin(inCSPin), mCtrlMeas(kCtrlMeas), mConfig(kConfig)
		...
		// Using SPI_MODE0 doesn't work correctly with some MCUs such as
		// the GD32F103CBT6.
		// The BMP280 doc states that either mode 00 or 11 should work.
	  , mSPISettings(10000000, MSBFIRST, SPI_MODE3)
#endif
{
