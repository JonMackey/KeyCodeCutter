...
namespace TeensyStep
{
    ...
    class Stepper
    {
        ...
        static constexpr uint32_t kDefaultPulseWidth = 4;
     ...
     public:
		...
		bool setupPulseTimer(unsigned pulseWidth = kDefaultPulseWidth);
		inline HardwareTimer&	getPulseTimer(void){return(pulseTimer);}
	#endif
     protected:
        inline void doStep();
